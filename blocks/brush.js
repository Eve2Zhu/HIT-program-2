...
Blockly.Blocks["poetry"] = {
  init: function () {
    this.appendDummyInput().appendField("李白");
...
Blockly.Blocks["answer_title_jys"] = {
  init: function () {
    this.appendDummyInput().appendField("《静夜思》");
...
Blockly.Blocks["answer_content_jys_01"] = {
  init: function () {
    this.appendDummyInput().appendField("床前明月光，");
...
Blockly.Blocks["answer_content_jys_02"] = {
  init: function () {
    this.appendDummyInput().appendField("疑是地上霜。");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip("");
...
Blockly.Blocks["answer_content_jys_03"] = {
  init: function () {
    this.appendDummyInput().appendField("举头望明月，");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip("");
...
Blockly.Blocks["answer_content_jys_04"] = {
  init: function () {
    this.appendDummyInput().appendField("低头思故乡。");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(230);
    this.setTooltip("");
