 ...
 */
Painting.blocks = [
  ['poetry', 'answer_title_jys', 'answer_content_jys_01', 'answer_content_jys_02', 'answer_content_jys_03', 'answer_content_jys_04']
];
...
Painting.run = function () {
  ...
  console.log(code)
  fetch(`http://localhost:3000/api/xf/tts?text=${code}`, {
    encoding: null
  })
    ...
    .then(result => {
      ...
      $audio.setAttribute('src', `./server/${result.sid}.wav`)
      $audio.play()
    })
